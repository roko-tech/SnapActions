...
| File | Package source |
| --- | --- |
| `QRCoder-LICENSE.txt` | `QRCoder` 1.8.0, `LICENSE.txt` |
...
The pinned .NET SDK 10.0.303 supplies runtime 10.0.11. Refresh the corresponding notices when upgrading QRCoder or the bundled runtime. The build copies this folder and the project's root `LICENSE` into the release package.
