...
public partial class ToolbarWindow
{
    ...
    private async void ActionButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (result.ResultText != null)
        {
            ...
            if (previous != null) ScheduleClipboardRestore(previous);
        }
        HideToolbar();
    }
    ...
    /// </summary>
    private static void ScheduleClipboardRestore(IDataObject snapshot)
    {
        Application.Current.Dispatcher.InvokeAsync(async () =>
        {
            await Task.Delay(3000);
            try { Clipboard.SetDataObject(snapshot, copy: true); }
