...
public static partial class UnitConverter
{
    ...
    private static Dictionary<string, Unit> BuildAliases()
    {
        ...
        Unit tonne = new("t", Category.Mass, 1000.0);          // metric tonne
        Unit shortTon = new("ton", Category.Mass, 907.18474);  // US short ton — the common meaning
                                                               // of the English word "ton" in the
                                                               // imperial context this table targets
        ...
        Add(d, shortTon, "ton", "tons");
        Add(d, tonne, "tonne", "tonnes", "t");
    ...
    public static IEnumerable<Unit> TargetsFor(Category cat) => cat switch
    {
        ...
        Category.Mass => [_aliases["mg"], _aliases["g"], _aliases["kg"], _aliases["t"], _aliases["ton"],
